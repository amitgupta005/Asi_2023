...
from utils import ActionExtractor
from utils import FeatureDiscretizer, FrequentRuleMiner
from utils import LimeEstimator
from pulp import CPLEX_PY
from pulp import GLPK
from utils import Action, ActionCandidates, ForestActionCandidates
...
if(__name__ == '__main__'):
    MAX_ITERATION = 50
    _check(dataset='L', model='T', params=(0.04, 1.0), max_iteration=2, lime_approximation=False, verbose=False)
